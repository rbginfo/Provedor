 ...
 * @author ricardo
 */
public class ClientePJInserirGUI extends javax.swing.JFrame {
    ...
    public ClientePJInserirGUI(DefaultTableModel modelo) {
        this.modelo = modelo;
        initComponents();
        carregaCombo();
    ...
    public ClientePJInserirGUI(DefaultTableModel modelo, int linhaSelecionada, int idClientePJ) {
        this.modelo = modelo;
        ...
        ClientePJ clientePJ = clientePJC.listById(idClientePJ);

        EnderecoController enderecoC = new EnderecoController();
        Endereco endereco = enderecoC.listById(clientePJ.getIdEndereco());

        ContatoController contatoC = new ContatoController();
        Contato contato = contatoC.listById(clientePJ.getIdContato());
        ...
        txId.setText(Integer.toString(clientePJ.getId()));
        txNomeFantasia.setText(clientePJ.getNomeFantasia());
        txRasaoSocial.setText(clientePJ.getRasaoSocial());
        txCnpj.setText(clientePJ.getCnpj());
        txIe.setText(clientePJ.getIe());
        txIm.setText(clientePJ.getiMunicipal());
        txDataContrato.setDate(clientePJ.getDataContrato());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro de Cliente Pessoa Jurídica"));
        ...
        jLabel18.setText("Data de Contrato:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txComplemento, javax.swing.GroupLayout.PREFERRED_SIZE, 419, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel12)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txCep, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txIe, javax.swing.GroupLayout.PREFERRED_SIZE, 203, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txDataContrato, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(jLabel5)
                                .addGap(18, 18, 18)
                                .addComponent(txIm, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(20, 20, 20)
                                .addComponent(txTelefone1, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txTelefone2, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel17)
                                .addGap(2, 2, 2)
                                .addComponent(txCelular, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txId, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void btGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGravarActionPerformed
        ...
        if (!(txId.getText().equals(""))) {
            clientePJ.setId(Integer.parseInt(txId.getText()));
            clientePJ = clientePJc.listById(Integer.parseInt(txId.getText()));

            end.setId(clientePJ.getIdEndereco());
            cont.setId(clientePJ.getIdContato());

        }

        clientePJ.setNomeFantasia(txNomeFantasia.getText());
        clientePJ.setRasaoSocial(txRasaoSocial.getText());
        clientePJ.setCnpj(removeMask(txCnpj.getText()));
        clientePJ.setIe(txIe.getText());
        clientePJ.setiMunicipal(txIm.getText());
        clientePJ.setDataContrato(txDataContrato.getDate());

        end.setId(ec.salvar(end));
        cont.setId(cc.salvar(cont));

        clientePJ.setEnd(end);
        clientePJ.setContato(cont);

        ValidacaoImplements validacao = new ValidacaoImplements();

        if (validacao.validaCNPJ(clientePJ.getCnpj()) == false) {
            ...
            if (clientePJ.getId() == 0) {
                int id = clientePJc.salvar(clientePJ);
                if (id > 0) {
                    modelo.addRow(new Object[]{id, clientePJ.getNomeFantasia(), clientePJ.getCnpj()});
                    JOptionPane.showMessageDialog(null, "Cliente Pessoa Jurídica cadastrado com sucesso");
                }
            } else {
                int id = clientePJc.salvar(clientePJ);
                if (id > 0) {
                    ...
                    modelo.addRow(new Object[]{id, clientePJ.getNomeFantasia(), clientePJ.getCnpj()});
                    JOptionPane.showMessageDialog(null, "Cliente Pessoa Jurídica atualizado com sucesso");
                }
            }
